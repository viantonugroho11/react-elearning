...
export default class IndexJadwal extends Component {
  render() {
    return (
      <div>
    ...
    <div className="min-height-200px">
      ...
      <div className="card-box mb-30">
        <div className="pd-20 d-flex justify-content-between">
          ...
          <a href="form-datasiswa.html" className="btn btn-sm btn-primary">+ tambah</a>
        </div>
        <div className="pb-20">
          <table className="data-table table stripe hover nowrap">
            <thead>
              <tr>
                <th className="table-plus datatable-nosort">Pelajaran</th>
                <th>Kelas</th>
                <th>Guru</th>
            ...
            <tbody>
              <tr>
                <td className="table-plus">Pelangi</td>
                <td>Biru</td>
                <td>Sagittarius</td>
                <td>
