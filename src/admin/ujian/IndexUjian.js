...
export default class IndexUjian extends Component {
  render() {
    return (
      <div>
    ...
    <div className="min-height-200px">
      ...
      <div className="card-box mb-kamis">
        <div className="pd-20 d-flex justify-content-between">
          ...
          <a href="form-dataguru.html" className="btn btn-sm btn-primary">+ tambah</a>
        </div>
        <div className="pb-20">
          <table className="data-table table stripe hover nowrap">
            <thead>
              <tr>
                <th className="table-plus datatable-nosort">Nama Ujian</th>
                <th>Jadwal</th>
                <th>Tanggal</th>
                <th>waktu Ujian</th>
                <th>jumlah soal</th>
