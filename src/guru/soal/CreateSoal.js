...
function CreateSoalGuru() {
  ...
  const storePost = async (e) => {
    ...
    await axios.post('http://appsiaksd.ugcorpusskkni.online/api/guru/tugas', formData)
      .then(() => {
                ...
                <div className="row">
                  <div className="col-md-12">
                    <div className="form-group">
                      ...
                      <textarea onChange={(e) => setSoal(e.target.value)} className="form-control" type="text" placeholder="Masukkan Masukkan Isi Soal" />
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-6">
                    <div className="form-group">
                      ...
                      <input onChange={(e) => setNama(e.target.value)} className="form-control" type="text" placeholder="Masukkan Nama Soal " />
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="form-group">
                      <label>Batas Soal</label>
                      <input onChange={(e) => setBatas(e.target.value)} className="form-control" type="date" placeholder="Masukkan Batas Soal Anda" />
                    </div>
                  </div>
                </div>
                <div className="form-group">
